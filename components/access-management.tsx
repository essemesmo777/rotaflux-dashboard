...
export default function AccessManagement({ mode }: { mode: "platform" | "company" }) {
  ...
  return <main className="admin-page">
    ...
    <section className="admin-main">
      ...
      <div className="admin-summary"><div className="summary-card"><span>{mode === "company" ? "Motoristas" : "Usuários"}</span><strong>{stats.users}</strong></div><div className="summary-card"><span>{mode === "company" ? "Motoristas ativos" : "Acessos ativos"}</span><strong>{stats.active}</strong></div><div className="summary-card"><span>Empresas</span><strong>{mode === "platform" ? stats.companies : 1}</strong></div></div>
